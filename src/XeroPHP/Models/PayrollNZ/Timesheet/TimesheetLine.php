...
class TimesheetLine extends Remote\Model
{
    ...
    {
        return [
            'TimesheetLineID' => [false, self::PROPERTY_TYPE_STRING, null, false, false],
            'Date' => [true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', false, false],
            'EarningsRateID' => [true, self::PROPERTY_TYPE_STRING, null, false, false],
            'TrackingItemID' => [false, self::PROPERTY_TYPE_STRING, null, false, false],
            'NumberOfUnits' => [true, self::PROPERTY_TYPE_FLOAT, null, false, false]
        ];
    }
     ...
     * @return TimesheetLine
     */
    public function setTimesheetLineID($value)
    {
        $this->propertyUpdated('TimesheetLineID', $value);
        $this->_data['TimesheetLineID'] = $value;
        return $this;
    }
